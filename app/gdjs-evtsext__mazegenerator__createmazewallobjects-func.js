...
{isConditionTrue_0 = (eventsFunctionContext.getArgument("HwallResizeWidth") > 0);
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (eventsFunctionContext.getArgument("HwallResizeHeight") > 0);
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects4.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects4[i].setWidth(eventsFunctionContext.getArgument("HwallResizeWidth"));
}
}{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects4.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects4[i].setHeight(eventsFunctionContext.getArgument("HwallResizeHeight"));
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = (eventsFunctionContext.getArgument("VwallResizeWidth") > 0);
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (eventsFunctionContext.getArgument("VwallResizeHeight") > 0);
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects4.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects4[i].setWidth(eventsFunctionContext.getArgument("VwallResizeWidth"));
}
}{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects4.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects4[i].setHeight(eventsFunctionContext.getArgument("VwallResizeHeight"));
}
}}
...
/* Reuse gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects3 */
{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects3.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects3[i].setPosition(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorX")) + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorWidth")) - (gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects3[i].getWidth()) / 2,gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorY")) + (gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorHeight")) / 2) - ((gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects3[i].getHeight()) / 2));
}
}}
...
/* Reuse gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects3 */
{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects3.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects3[i].setPosition(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorX")) + (gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorWidth")) / 2) - ((gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects3[i].getWidth()) / 2),gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorY")) + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorHeight")) - (gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects3[i].getHeight()) / 2);
}
}}
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.mapOfGDgdjs_9546evtsExt_9595_9595MazeGenerator_9595_9595CreateMazeWallObjects_9546GDHwallObjects3Objects, 0, 0, eventsFunctionContext.getArgument("Layer"));
    ...
    gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects3[i].setZOrder(eventsFunctionContext.getArgument("Zorder"));
}
}{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects3.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects3[i].returnVariable(gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects3[i].getVariables().get("__MazeGenerator_MazeID")).setString(eventsFunctionContext.getArgument("MazeID"));
}
}{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDHwallObjects3.length ;i < len;++i) {
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.mapOfGDgdjs_9546evtsExt_9595_9595MazeGenerator_9595_9595CreateMazeWallObjects_9546GDVwallObjects3Objects, 0, 0, eventsFunctionContext.getArgument("Layer"));
    ...
    gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects3[i].setZOrder(eventsFunctionContext.getArgument("Zorder"));
}
}{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects3.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects3[i].returnVariable(gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects3[i].getVariables().get("__MazeGenerator_MazeID")).setString(eventsFunctionContext.getArgument("MazeID"));
}
}{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeWallObjects.GDVwallObjects3.length ;i < len;++i) {
...
if (true)
{
{runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorX").setNumber(gdjs.evtTools.common.mod(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Index")), gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("NumColumns"))) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorWidth")) + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("MazeX")));
}{runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorY").setNumber(Math.floor(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Index")) / gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("NumColumns"))) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorHeight")) + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("MazeY")));
}
{ //Subevents: 
