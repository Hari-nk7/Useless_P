...
if (true)
{
{gdjs.evtTools.variable.valuePush(runtimeScene.getScene().getVariables().get("MazeGeneratorPath").getChild(eventsFunctionContext.getArgument("StructureName")), gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("PathChild")));
}}
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (gdjs.evtTools.variable.getVariableChildCount(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Path")) < gdjs.evtTools.variable.getVariableChildCount(runtimeScene.getScene().getVariables().get("MazeGeneratorPath").getChild(eventsFunctionContext.getArgument("StructureName"))));
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.variable.variableClearChildren(runtimeScene.getScene().getVariables().get("MazeGeneratorPath").getChild(eventsFunctionContext.getArgument("StructureName")));
}
{ //Subevents
...
}{runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("StartIndex").setNumber((eventsFunctionContext.getArgument("StartRow") - 1) * gdjs.evtsExt__MazeGenerator__MazeNumColumns.func(runtimeScene, eventsFunctionContext.getArgument("MazeID"), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) + (eventsFunctionContext.getArgument("StartColumn") - 1));
}{runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("EndIndex").setNumber((eventsFunctionContext.getArgument("EndRow") - 1) * gdjs.evtsExt__MazeGenerator__MazeNumColumns.func(runtimeScene, eventsFunctionContext.getArgument("MazeID"), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) + (eventsFunctionContext.getArgument("EndColumn") - 1));
}}
...
}{gdjs.evtTools.variable.valuePush(runtimeScene.getScene().getVariables().get("MazeGeneratorPath").getChild(eventsFunctionContext.getArgument("StructureName")), "NoPath");
}}
}
