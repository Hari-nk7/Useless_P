...
{isConditionTrue_0 = (eventsFunctionContext.getArgument("ResizeWidth") > 0);
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (eventsFunctionContext.getArgument("ResizeHeight") > 0);
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects4.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects4[i].setWidth(eventsFunctionContext.getArgument("ResizeWidth"));
}
}{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects4.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects4[i].setHeight(eventsFunctionContext.getArgument("ResizeHeight"));
}
}}
...
/* Reuse gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3 */
{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3[i].setPosition(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorX")) + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorWidth")) - (gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3[i].getWidth()) / 2,gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorY")) - (gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3[i].getHeight()) / 2);
}
}}
...
/* Reuse gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3 */
{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3[i].setPosition(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorX")) - (gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3[i].getWidth()) / 2,gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorY")) + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorHeight")) - (gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3[i].getHeight()) / 2);
}
}}
...
isConditionTrue_2 = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("LeftWall").getChild(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Index"))), true);
if (isConditionTrue_2) {
isConditionTrue_2 = false;
isConditionTrue_2 = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("UpWall").getChild(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Index"))), true);
}
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.mapOfGDgdjs_9546evtsExt_9595_9595MazeGenerator_9595_9595CreateMazeCornerObjects_9546GDCornerObjects3Objects, 0, 0, eventsFunctionContext.getArgument("Layer"));
    ...
    gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3[i].setZOrder(eventsFunctionContext.getArgument("Zorder"));
}
}{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3[i].returnVariable(gdjs.evtsExt__MazeGenerator__CreateMazeCornerObjects.GDCornerObjects3[i].getVariables().get("__MazeGenerator_MazeID")).setString(eventsFunctionContext.getArgument("MazeID"));
}
}
{ //Subevents
...
{let isConditionTrue_2 = false;
isConditionTrue_2 = false;
isConditionTrue_2 = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("RightWall").getChild(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Index"))), true);
if (isConditionTrue_2) {
isConditionTrue_2 = false;
isConditionTrue_2 = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("UpWall").getChild(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Index"))), true);
}
...
if (isConditionTrue_2) {
isConditionTrue_2 = false;
isConditionTrue_2 = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("DownWall").getChild(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Index"))), true);
}
isConditionTrue_1 = isConditionTrue_2;
}
if(isConditionTrue_1) {
