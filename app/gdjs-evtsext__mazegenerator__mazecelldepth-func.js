...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = (gdjs.evtsExt__MazeGenerator__MazeNumWalls.func(runtimeScene, eventsFunctionContext.getArgument("MazeID"), Math.floor(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Index")) / gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("NumColumns"))) + 1, gdjs.evtTools.common.mod(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Index")), gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("NumColumns"))) + 1, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) == 1);
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
}{runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("MinDepth").setNumber(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("NumberOfCells")) + 1);
}}
...
let isConditionTrue_0 = false;
{
{gdjs.evtTools.variable.valuePush(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorInProgress"), (eventsFunctionContext.getArgument("RowNumber") - 1) * gdjs.evtsExt__MazeGenerator__MazeNumColumns.func(runtimeScene, eventsFunctionContext.getArgument("MazeID"), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) + (eventsFunctionContext.getArgument("ColumnNumber") - 1));
