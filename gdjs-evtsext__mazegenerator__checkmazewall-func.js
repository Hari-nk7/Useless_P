...
isConditionTrue_0 = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild(eventsFunctionContext.getArgument("WallDirection")).getChild((eventsFunctionContext.getArgument("RowNum") - 1) * gdjs.evtsExt__MazeGenerator__MazeNumColumns.func(runtimeScene, eventsFunctionContext.getArgument("MazeID"), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) + (eventsFunctionContext.getArgument("ColumnNum") - 1)), true);
