...
{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects3.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects3[i].setWidth(eventsFunctionContext.getArgument("ResizeWidth"));
}
}{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects3.length ;i < len;++i) {
    gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects3[i].setHeight(eventsFunctionContext.getArgument("ResizeHeight"));
}
}}
...
{runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorX").setNumber(gdjs.evtTools.common.mod(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("Index")), gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("NumColumns"))) * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorWidth")) + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("MazeX")));
    ...
    gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects3[i].setPosition(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorX")) + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorWidth")) / 2 - (gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects3[i].getWidth()) / 2,gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild("FloorY")) + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__MazeGenerator").getChild(eventsFunctionContext.getArgument("MazeID")).getChild("FloorHeight")) / 2 - (gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects3[i].getHeight()) / 2);
}
}}
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.mapOfGDgdjs_9546evtsExt_9595_9595MazeGenerator_9595_9595CreateMazeFloorObjects_9546GDFloorObjectObjects2Objects, 0, 0, eventsFunctionContext.getArgument("Layer"));
    ...
    gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects2[i].setZOrder(eventsFunctionContext.getArgument("Zorder"));
}
}{for(var i = 0, len = gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects2.length ;i < len;++i) {
    ...
    gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects2[i].returnVariable(gdjs.evtsExt__MazeGenerator__CreateMazeFloorObjects.GDFloorObjectObjects2[i].getVariables().get("__MazeGenerator_MazeID")).setString(eventsFunctionContext.getArgument("MazeID"));
}
}
{ //Subevents: 
